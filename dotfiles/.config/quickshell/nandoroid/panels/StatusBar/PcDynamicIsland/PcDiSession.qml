...
Item {
    ...
    readonly property var actions: [
        { icon: "lock",              label: I18nService.tr("Lock"),     action: () => Session.lock() },
        { icon: "dark_mode",         label: I18nService.tr("Sleep"),    action: () => Session.suspend() },
        { icon: "restart_alt",       label: I18nService.tr("Reboot"),   action: () => Session.reboot() },
        { icon: "power_settings_new", label: I18nService.tr("Shutdown"), action: () => Session.poweroff() }
    ]
